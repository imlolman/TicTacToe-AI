class Pwa {
    ...
    constructor(self) {
        ...
        this.BASE_CACHE_FILES = [
            ...
            'assets/css/milligram.min.css.map',
            'assets/css/style.css',
            'assets/css/fa/css/all.css',
            'assets/css/fa/css/all.min.css',
            'assets/css/fa/css/brands.css',
            'assets/css/fa/css/brands.min.css',
            'assets/css/fa/css/fontawesome.css',
            'assets/css/fa/css/fontawesome.min.css',
            'assets/css/fa/css/regular.css',
            'assets/css/fa/css/regular.min.css',
            'assets/css/fa/css/solid.css',
            'assets/css/fa/css/solid.min.css',
            'assets/css/fa/css/svg-with-js.css',
            'assets/css/fa/css/svg-with-js.min.css',
            'assets/css/fa/css/v4-shims.css',
            'assets/css/fa/css/v4-shims.min.css',
            'assets/css/fa/webfonts/fa-brands-400.eot',
            'assets/css/fa/webfonts/fa-brands-400.svg',
            'assets/css/fa/webfonts/fa-brands-400.ttf',
            'assets/css/fa/webfonts/fa-brands-400.woff',
            'assets/css/fa/webfonts/fa-brands-400.woff2',
            'assets/css/fa/webfonts/fa-regular-400.eot',
            'assets/css/fa/webfonts/fa-regular-400.svg',
            'assets/css/fa/webfonts/fa-regular-400.ttf',
            'assets/css/fa/webfonts/fa-regular-400.woff',
            'assets/css/fa/webfonts/fa-regular-400.woff2',
            'assets/css/fa/webfonts/fa-solid-900.eot',
            'assets/css/fa/webfonts/fa-solid-900.svg',
            'assets/css/fa/webfonts/fa-solid-900.ttf',
            'assets/css/fa/webfonts/fa-solid-900.woff',
